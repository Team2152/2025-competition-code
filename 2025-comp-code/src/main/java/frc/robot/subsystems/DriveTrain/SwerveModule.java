...
import com.revrobotics.spark.SparkMax; //formerly aka import com.revrobotics.CANSparkMax; //import com.revrobotics.CANSparkLowLevel.MotorType; 
...
public class SwerveModule {
  ...
  public SwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    ...
    m_turningSparkMax.configure(config, safe_params, PersistMode.kPersistParameters);
    ...
    SparkFlexConfig configSpark = new SparkFlexConfig();
